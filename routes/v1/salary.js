...
function getRouter() {
    ...
    router.get('/salary-months/:year', auth.role('user'), salaryMonths);
    router.get('/salary/:month', auth.role('user'), salary);
    router.get('/bonus/:month', auth.role('user'), bonus);
    router.get('/monthlyduty/:month', auth.role('user'), monthlyduty);
...
function salaryMonths(req, res, next) {
console.log(req.params.year);
console.log(req.user.empno );
